 ...
 */
export function sleepCt(millis, ct) {
 ...
 */
export function signed13FromUnsigned13(val) {
    let ret = val & 0x0FFF;
    if (val & 0x1000) {
        return ret - 0x1000;
    }
 ...
 */
export function signed16FromUnsigned16(val) {
    let ret = val & 0x7FFF;
    if (val & 0x8000) {
        return ret - 0x8000;
    }
 ...
 * @returns The unsigned 16 bit number
 */
export function unsigned16FromSigned16(val) {
    if (val >= 0) {
        return val & 0x7FFF;
    }
    else {
